...
const routes = [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        path: '/rules/PrivateRoute',
        exact: true,
        component: require('../rules/PrivateRoute.js').default,
        title: '用户中心',
        Routes: [require('../../routes/PrivateRoute.js').default],
      },
      {
        ...
        routes: [
          ...
          },
          {
            component: () =>
              React.createElement(
                require('/Volumes/9/mine/code/react/umikuangjiaAntDesign/node_modules/umi-build-dev/lib/plugins/404/NotFound.js')
                  .default,
